...
L_silicone = [2.5*4.4]; %In mm, looks roughly 2.5x the width.
G = 0.23*(10)^6; % in Pa
W = 4.4; %in mm
H = 2;%in mm
...
sigma = Factive.*(L+0.045)./C %im not sure what L they use, it should be the center to center between two hexbugs, their
