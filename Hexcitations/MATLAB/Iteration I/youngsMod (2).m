...
names = {'small','medium','large'};        % labels
k_vals = [0.0614, 0.0486, 0.0362];       % spring constants (N/mm)
L_vals = [35.56, 45.72, 55.88];                   % rod lengths (mm) -- change to your actual L
% Rectangular cross-section dimensions (mm)
b = 2.59;    % width (mm)  -- change to your measured width
h = 4.6;    % thickness (mm) -- change to thickness in bending direction
